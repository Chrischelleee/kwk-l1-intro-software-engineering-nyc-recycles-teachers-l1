...
def all_keys(first_recycling_bin)
  first_recycling_bin.each_key do |keys|
    puts "#{keys}"
  end
end
...
def all_data(second_recycling_bin)
  second_recycling_bin.each_value do |value|
    puts "#{value}"
  end
end
...
def key_and_data(fourth_recycling_bin)
  fourth_recycling_bin.each do |keys, value|
    puts "The #{keys} is #{value}"
  end
end
